class TeamsController < ApplicationController
  ...
  #   teams = Team.all
  #   apple = 1
  #   render json: { teams: teams.as_json, apple: apple.as_json }
  # end
  ...
  def datedshow
    ...
    team = Score.all.where("home_team_id": params[:id]).where("date>=? AND date<=?", params[:start_date], params[:end_date])
    team.each do |score|
      if score.home_team_cover == "Yes"
        home_cover += 1
      elsif score.home_team_cover == "No"
    ...
    team = Score.all.where("away_team_id": params[:id]).where("date>=? AND date<=?", params[:start_date], params[:end_date])
    team.each do |score|
      if score.away_team_cover == "Yes"
        away_cover += 1
      elsif score.away_team_cover == "No"
  ...
  def datedoppshow
    ...
    team = Score.all.where("home_team_id": params[:id]).where("date>=? AND date<=?", params[:start_date], params[:end_date]).where("home_team =? OR away_team =?", params[:opp], params[:opp])
    team.each do |score|
      if score.home_team_cover == "Yes"
        home_cover += 1
      elsif score.home_team_cover == "No"
    ...
    team = Score.all.where("away_team_id": params[:id]).where("date>=? AND date<=?", params[:start_date], params[:end_date]).where("home_team =? OR away_team =?", params[:opp], params[:opp])
    team.each do |score|
      if score.away_team_cover == "Yes"
        away_cover += 1
      elsif score.away_team_cover == "No"
  ...
  #s
  def oppshow
    scores = Score.where("home_team_id =? OR away_team_id =?", params[:id], params[:id]).where("home_team =? OR away_team =?", params[:opp], params[:opp])
    ...
    team = Score.all.where("home_team_id": params[:id]).where("home_team =? OR away_team =?", params[:opp], params[:opp])
    team.each do |score|
      if score.home_team_cover == "Yes"
        home_cover += 1
      elsif score.home_team_cover == "No"
    ...
    team = Score.all.where("away_team_id": params[:id]).where("home_team =? OR away_team =?", params[:opp], params[:opp])
    team.each do |score|
      if score.away_team_cover == "Yes"
        away_cover += 1
      elsif score.away_team_cover == "No"
  ...
  def homeshow
    scores = Score.where(home_team_id: params[:id])
  ...
  def awayshow
    scores = Score.where(away_team_id: params[:id])
